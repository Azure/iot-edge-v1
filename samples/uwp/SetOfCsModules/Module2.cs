...
{
    public sealed class Module2 : IGatewayModule
    {
        public void Create(MessageBus bus, string configuration)
        {
            ...
            new Task(() => {
                for (int i = 0; i < 3; i++)
                {
                    ...
                    props.Add("SetOfCsModules.Module2", i.ToString());
                    bus.Publish(new Microsoft.Azure.IoT.Gateway.Message("SetOfCsModules.Module2 says hello!!!", props));
                }
            }).Start();
        }
        ...
        public void Receive(Message received_message)
        {
            ...
            sb.Append("SetOfCsModules.Module2.Receive: Content=" + content.ToString() + "\r\n");
            sb.Append("SetOfCsModules.Module2.Receive: Properties={" + propsString.ToString() + "}\r\n");
