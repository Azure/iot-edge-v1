...
The JSON below is the code from one of the JSON files [`hello_world_lin.json`](./src/hello_world_lin.json) used to configure the Hello World sample. There are a couple things to note:
