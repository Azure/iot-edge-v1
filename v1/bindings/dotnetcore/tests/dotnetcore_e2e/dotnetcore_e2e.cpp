...
BEGIN_TEST_SUITE(dotnetcore_e2e)
...
TEST_FUNCTION(GW_dotnetcore_binding_e2e_Managed2Managed)
{
    ///arrange
	...
	DOTNET_CORE_LOADER_ENTRYPOINT senderEndpoint =
	{
	...
	DOTNET_CORE_LOADER_ENTRYPOINT receiverEndpoint =
	{
		STRING_construct("E2ETestModule"),
		STRING_construct("E2ETestModule.DotNetE2ETestModule")
	};
	...
	STRING_delete(senderEndpoint.dotnetCoreModuleEntryClass);
	STRING_delete(senderEndpoint.dotnetCoreModulePath);
	STRING_delete(receiverEndpoint.dotnetCoreModuleEntryClass);
	STRING_delete(receiverEndpoint.dotnetCoreModulePath);
	VECTOR_destroy(properties.gateway_modules);
	VECTOR_destroy(properties.gateway_links);

}
END_TEST_SUITE(dotnetcore_e2e)
