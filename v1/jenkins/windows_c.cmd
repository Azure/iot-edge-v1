...
call build.cmd --run-unittests --run-e2e-tests --enable-nodejs-binding --enable-dotnet-binding --enable-dotnet-core-binding --enable-java-binding --enable-native-remote-modules --enable-java-remote-modules --enable-nodejs-remote-modules %*
