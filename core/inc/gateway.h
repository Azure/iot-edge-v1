...
typedef enum GATEWAY_EVENT_TAG
{
	 ...
	 *
	 * The VECTOR_HANDLE from #Gateway_GetModuleList will be provided as the context to the callback,
...
*
*   @param 		module_list	A vector handle as returned from @c Gateway_GetModuleList
*/
