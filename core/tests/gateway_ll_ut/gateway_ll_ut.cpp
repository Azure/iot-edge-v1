...
public:
    ...
    MOCK_STATIC_METHOD_1(, const MODULE_API*, DynamicModuleLoader_GetModuleApi, MODULE_LIBRARY_HANDLE, module_library_handle)
...
BEGIN_TEST_SUITE(gateway_ll_ut)
...
/*Tests_SRS_GATEWAY_LL_14_011: [ If gw, entry, or GATEWAY_MODULES_ENTRY's loader_configuration or loader_api is NULL the function shall return NULL. ]*/
TEST_FUNCTION(Gateway_LL_Create_returns_null_on_invalid_GW_entry)
{
	//Arrange
	CGatewayLLMocks mocks;
	...
	//Act
	GATEWAY_HANDLE gateway = Gateway_LL_Create(&newdummyProps);
...
TEST_FUNCTION(Gateway_LL_Create_VECTOR_Create2_Fails)
{
    //Arrange
    CGatewayLLMocks mocks;
...
TEST_FUNCTION(Gateway_LL_AddModule_Returns_Null_For_null_module_name)
{
	//Arrange
	CGatewayLLMocks mocks;
...
//Tests_SRS_GATEWAY_LL_17_001: [ This function shall not accept "*" as a module name. ]
TEST_FUNCTION(Gateway_LL_AddModule_Returns_Null_For_star_module_name)
{
    //Arrange
    CGatewayLLMocks mocks;
...
/*Tests_SRS_GATEWAY_LL_14_013: [ The function shall get the const MODULE_API* from the MODULE_LIBRARY_HANDLE. ]*/
/*Tests_SRS_GATEWAY_LL_17_015: [ The function shall use GATEWAY_PROPERTIES::loader_api->Load and each GATEWAY_PROPERTIES::loader_configuration to get each module's MODULE_LIBRARY_HANDLE. ]*/
...
/*Tests_SRS_GATEWAY_LL_14_029: [ The function shall create a new MODULE_DATA containing the MODULE_HANDLE, MODULE_LOADER_API and MODULE_LIBRARY_HANDLE if the module was successfully linked to the message broker. ]*/
...
TEST_FUNCTION(Gateway_LL_AddModule_Malloc_data_Fails)
{
    //Arrange
    CGatewayLLMocks mocks;
...
/*Tests_SRS_GATEWAY_LL_14_015: [ The function shall use the MODULE_API to create a MODULE_HANDLE using the GATEWAY_MODULES_ENTRY's module_properties. ]*/
...
TEST_FUNCTION(Gateway_LL_AddModule_fails_on_null_loader_api)
{
	//Arrange
	CGatewayLLMocks mocks;
...
/*Tests_SRS_GATEWAY_LL_14_024: [ The function shall use the MODULE_DATA's module_library_handle to retrieve the MODULE_API and destroy module. ]*/
...
TEST_FUNCTION(Gateway_LL_RemoveLink_NonExistingSinkModule_Find_star_Link_Data_Failure)
{
    //Arrange
    CGatewayLLMocks mocks;
    GATEWAY_HANDLE gw = Gateway_LL_Create(NULL);
...
TEST_FUNCTION(Gateway_LL_AddLink_pushback_fails)
{
    //Arrange
    CGatewayLLMocks mocks;
...
TEST_FUNCTION(Gateway_LL_AddLink_broker_add_fails)
{
    //Arrange
    CGatewayLLMocks mocks;
...
TEST_FUNCTION(Gateway_LL_AddLink_star_2nd_addbroker_fails)
{
    //Arrange
    CGatewayLLMocks mocks;
    ...
    GATEWAY_ADD_LINK_RESULT result = Gateway_LL_AddLink(gateway, &dummyLink1);
    ...
    result = Gateway_LL_AddLink(gateway, &dummyLink2);
...
TEST_FUNCTION(Gateway_LL_AddLink_star_2nd_add_push_fails)
{
    //Arrange
    CGatewayLLMocks mocks;
...
//Tests_SRS_GATEWAY_LL_17_003: [ The gateway shall treat a source of "*" as link to the sink module from every other module in gateway. ]
//Tests_SRS_GATEWAY_LL_17_005: [ For this link, the sink shall receive all messages publish by other modules. ]
TEST_FUNCTION(Gateway_LL_AddModule_Creates_Module_with_star_links)
{
    //Arrange
    CGatewayLLMocks mocks;
    ...
    //Act
    MODULE_HANDLE handle = Gateway_LL_AddModule(gateway, &dummyEntry3);
...
//Tests_SRS_GATEWAY_LL_17_003: [ The gateway shall treat a source of "*" as link to the sink module from every other module in gateway. ]
//Tests_SRS_GATEWAY_LL_17_005: [ For this link, the sink shall receive all messages publish by other modules. ]
TEST_FUNCTION(Gateway_LL_AddModule_Creates_Module_star_2nd_addLink_fails)
{
    //Arrange
    CGatewayLLMocks mocks;
...
//Tests_SRS_GATEWAY_LL_17_003: [ The gateway shall treat a source of "*" as link to the sink module from every other module in gateway. ]
//Tests_SRS_GATEWAY_LL_17_005: [ For this link, the sink shall receive all messages publish by other modules. ]
TEST_FUNCTION(Gateway_LL_AddModule_Creates_Module_star_2nd_find_fails)
{
    //Arrange
    CGatewayLLMocks mocks;
...
//Tests_SRS_GATEWAY_LL_17_002: [ The gateway shall accept a link with a source of "*" and a sink of a valid module. ]
//Tests_SRS_GATEWAY_LL_17_003: [ The gateway shall treat a source of "*" as link to the sink module from every other module in gateway. ]
//Tests_SRS_GATEWAY_LL_17_004: [ The gateway shall accept a link containing "*" as entryLink->module_source, and a valid module name as a entryLink->module_sink. ]
//Tests_SRS_GATEWAY_LL_17_005: [ For this link, the sink shall receive all messages publish by other modules. ]
TEST_FUNCTION(Gateway_LL_AddLink_star_success)
{
    //Arrange
    CGatewayLLMocks mocks;
    ...
    ///Act
    GATEWAY_ADD_LINK_RESULT result = Gateway_LL_AddLink(gateway, &dummyLink2);
...
//Tests_SRS_GATEWAY_LL_17_004: [ The gateway shall accept a link containing "*" as entryLink->module_source, and a valid module name as a entryLink->module_sink. ]
TEST_FUNCTION(Gateway_LL_AddLink_star_no_sink)
{
    //Arrange
    CGatewayLLMocks mocks;
...
//Tests_SRS_GATEWAY_LL_17_003: [ The gateway shall treat a source of "*" as link to the sink module from every other module in gateway. ]
TEST_FUNCTION(Gateway_LL_AddLink_star_failure_to_add)
{
    //Arrange
    CGatewayLLMocks mocks;
...
//Tests_SRS_GATEWAY_LL_17_003: [ The gateway shall treat a source of "*" as link to the sink module from every other module in gateway. ]
TEST_FUNCTION(Gateway_LL_RemoveModule_with_star_links)
{
    //Arrange
    CGatewayLLMocks mocks;
    ...
    GATEWAY_HANDLE gateway = Gateway_LL_Create(dummyProps);
    auto module_handle = Gateway_LL_AddModule(gateway, &dummyEntry3);
...
//Tests_SRS_GATEWAY_LL_17_003: [ The gateway shall treat a source of "*" as link to the sink module from every other module in gateway. ]
TEST_FUNCTION(Gateway_LL_RemoveModule_with_star_links_has_errors)
{
    //Arrange
    CGatewayLLMocks mocks;
...
//Tests_SRS_GATEWAY_LL_17_003: [ The gateway shall treat a source of "*" as link to the sink module from every other module in gateway. ]
TEST_FUNCTION(Gateway_LL_RemoveLink_star_link_success)
{
    //Arrange
    CGatewayLLMocks mocks;
...
//Tests_SRS_GATEWAY_LL_17_003: [ The gateway shall treat a source of "*" as link to the sink module from every other module in gateway. ]
TEST_FUNCTION(Gateway_LL_RemoveLink_nostar_link_success)
{
    //Arrange
    CGatewayLLMocks mocks;
    ...
    //Act
    Gateway_LL_RemoveLink(gateway, &dummyLink3);
...
TEST_FUNCTION(Gateway_LL_RemoveModuleByName_success)
{
    ...
    EXPECTED_CALL(mocks, DynamicModuleLoader_Unload(IGNORED_PTR_ARG));
...
/*Tests_SRS_GATEWAY_LL_26_020: [ The function shall make a copy of the name of the module for internal use. ]*/
TEST_FUNCTION(Gateway_LL_AddModule_name_is_copied)
{
    // Arrange
    CNiceCallComparer<CGatewayLLMocks> mocks;
    ...
    auto gateway = Gateway_LL_Create(&props);
    name[0] = 'X';
    auto module_list = Gateway_LL_GetModuleList(gateway);
    ...
    VECTOR_destroy(props.gateway_modules);
    free(name);
    Gateway_LL_DestroyModuleList(module_list);
    Gateway_LL_Destroy(gateway);
}

/*Tests_SRS_GATEWAY_LL_14_030: [ If any internal API call is unsuccessful after a module is created, the library will be unloaded and the module destroyed. ] */
TEST_FUNCTION(Gateway_LL_AddModule_malloc_name_fail)
{
    // Arrange
    CGatewayLLMocks mocks;
    auto gateway = Gateway_LL_Create(NULL);
    ...
    // Act
    auto result = Gateway_LL_AddModule(gateway, &module);
