...
TEST_FUNCTION(Gateway_LL_Event_System_Create_Fail)
{
	...
	STRICT_EXPECTED_CALL(mocks, EventSystem_ReportEvent(NULL, IGNORED_PTR_ARG, GATEWAY_DESTROYED))
		.IgnoreArgument(2);
	STRICT_EXPECTED_CALL(mocks, EventSystem_Destroy(NULL));
