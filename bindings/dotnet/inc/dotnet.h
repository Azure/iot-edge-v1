...
extern __declspec(dllexport) bool Module_DotNetHost_PublishMessage(BROKER_HANDLE bus, MODULE_HANDLE sourceModule, const unsigned char* message, int32_t size);
