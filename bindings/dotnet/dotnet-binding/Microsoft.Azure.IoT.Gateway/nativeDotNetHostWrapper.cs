...
namespace Microsoft.Azure.IoT.Gateway
{
    ...
    public class NativeDotNetHostWrapper
    {
        ...
        /// </summary>
        /// <param name="messageBus">Handle to the message broker.</param>
        ...
        public static extern bool Module_DotNetHost_PublishMessage(IntPtr messageBus, IntPtr sourceModule, byte[] message, Int32 size);
        ...
        /// <param name="source">Message content as a byte array.</param>
        /// <returns></returns>
        virtual public bool PublishMessage(IntPtr messageBus, IntPtr sourceModule, byte[] message)
        {
            return Module_DotNetHost_PublishMessage(messageBus, sourceModule, message, message.Length);
        }
    }
}
